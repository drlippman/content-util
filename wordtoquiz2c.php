...
if (!isset($_POST['text'])) {
	...
	echo '<p>Copy-paste in the quiz below.  To be processed correctly:</p><ul><li>Do not use auto-numbering</li><li>Number the questions in the form 1. question</li><li>Letter the options in form A. choice<li>Mark the correct answer with a * at the beginning (before the letter) or end</li></ul>';
